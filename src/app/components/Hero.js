          ...
          >
            ...
            <div className="flex flex-wrap gap-4 items-center">
              <button
                type="button"
                onClick={onOpenModal}
                className="group relative inline-flex items-center justify-center px-9 py-4 md:px-10 md:py-5 font-black text-[11px] tracking-[0.14em] bg-yellow-400 text-black rounded-sm overflow-hidden transition-all duration-300 hover:bg-orange-400 active:scale-95 shadow-xl uppercase border-2 border-transparent"
              >
                <span className="relative z-10">👉 SOLICITE SUA COTAÇÃO</span>
              </button>
              <a
                href="#produtos"
                className="text-[11px] font-black uppercase tracking-[0.12em] text-yellow-400 hover:text-orange-400 transition-colors underline-offset-4 hover:underline"
              >
